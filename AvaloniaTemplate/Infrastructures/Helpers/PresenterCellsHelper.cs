...
{
    public class PresenterCellsHelper
    {
        ...
        public PresenterCellsHelper() { }
        public PresenterCellsHelper(PresenterCells presenter)
        {
        ...
        static PresenterCellsHelper()
        {
            SelectedChangeControlProperty.Changed.AddClassHandler<PresenterCells>(RegisterSelectedChangeControl);
        }

        public static readonly AttachedProperty<bool> SelectedChangeControlProperty
            = AvaloniaProperty.RegisterAttached<PresenterCellsHelper, Control, bool>("SelectedChangeControl");
        ...
        private static void RegisterSelectedChangeControl(PresenterCells presenter, AvaloniaPropertyChangedEventArgs e)
        {
            if (Design.IsDesignMode)
                return;

            if (e.NewValue is bool)
                _ = new PresenterCellsHelper(presenter);
        }
