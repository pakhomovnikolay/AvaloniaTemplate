...
namespace AvaloniaTemplate.Infrastructures.Helpers
{
    public class PresenterColumnsHelper
    {
        ...
        //    TableFactory.SelectedModel.SelectedModelCells.Clear();
        //    foreach (var row in TableFactory.SelectedModel.Rows)
        //        TableFactory.SelectedModel.SelectedModelCells.Add(row.Cells[item.Index]);

        //    TableFactory.SelectedModel.SelectedModelCell = TableFactory.SelectedModel.Rows[0].Cells[item.Index];
        //    TableFactory?.UpdateAnchorArea();
        //}
        //#endregion
        ...
        //    TableFactory.SelectedModel.UpdateSelectedModelColumns(true);
        //}
        //#endregion
        ...
        //    else
        //    {
        //        while (TableFactory.SelectedModel.SelectedModelColumns.Contains(item))
        //            TableFactory.SelectedModel.SelectedModelColumns.Remove(item);

        //        if (TableFactory.SelectedModel.SelectedModelColumn.Equals(item))
        //            TableFactory.SelectedModel.SelectedModelColumn = TableFactory.SelectedModel.SelectedModelColumns?.LastOrDefault();
        //    }
        //    TableFactory?.UpdateAnchorArea();
        //}
        //#endregion
